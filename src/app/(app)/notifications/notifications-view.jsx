...
export default function NotificationsView({ initialNotifications = [] }) {
  const [tab, setTab] = useState('All')
  const [items, setItems] = useState(initialNotifications.length > 0 ? initialNotifications : NOTIFICATIONS)
